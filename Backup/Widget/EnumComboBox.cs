    ...
    public partial class EnumComboBox : UserControl
    {
        ...
        public Type DataSource
        {
            ...
            set 
            {
                ...
                this.comboBox1.DataSource = Enum.GetValues(value);// EnumHelper.ConvertEnumToFieldDescriptionList(this.dataSource);
        ...
        public object SelectedValue
        {
            get
            {
                ...
                return Enum.Parse((Type)this.dataSource, this.comboBox1.SelectedItem.ToString()); //EnumHelper.ParseEnumValue(this.dataSource ,this.comboBox1.SelectedItem.ToString());
            }
            set
            {
                if (value == null)
